...
This article will discuss the creation and testing of the hi-fi prototype in Figma. It will also showcase a few of the main pages in the site.
...
![catalogue page](./assets/img/cupcakePage.png)
...
![Item page](./assets/img/singleCupcakePage.png)
...
![Cart page](./assets/img/cartPage.png)
...
![Review order page](./assets/img/myOrdersFound.png)
