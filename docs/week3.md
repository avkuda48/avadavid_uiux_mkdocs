...
**As a (user type), I want to (feature) so that I can (user goal).**
...
This tells me that I need a page to show the user the date, time, and location of their cupcake delivery.
...
This means I need to better structure the catalogue so that it is more accessible and easy to understand. I also need to streamline the ordering process so it makes clear and total sense.

## User Scenarios

Finally, user scenarios help a developer to begin to mock up the page structure and flow of the website. Take your user story and create a high-level file path that describes how the user will go about completing their goal.  
