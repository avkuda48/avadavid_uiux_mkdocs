...
This documentation is intended for employers who are interested in my ability to redesign brands and websites. It details my process from start to finish.

## Outcome

The goal of this project is to redesign a poorly made website to better adhere to UI/UX standards, demonstrating my knowledge of design and user experience. The result will be a polished prototype of the new site in Figma.

### Possible Websites to Redesign

My partner and I found five websites that had UI/UX issues. Those Five websites were:
...
We eliminated Stack Overflow and BCIT Student Self Service because they had too many pages for the given time frame.

We then eliminated the ACT program at MIT's website as there was mainly just accessability work to be done, though it was a very interesting visual concept.
...
I am working with a partner for this project, which will help me better understand common problems I may encounter when working in a team and figure them out in a safe environment.

### Hopes and Goals

My main goal for this project is to gain experience working on a project with another dev.  
